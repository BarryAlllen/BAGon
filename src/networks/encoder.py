...
class EncoderV2(nn.Module):
    def __init__(self, in_channels=3, out_channels=3):
        ...
        self.conv_block_2 = DoubleConvBatchNormReluBlock(in_channels=8, out_channels=16)
        self.conv_block_3 = DoubleConvBatchNormReluBlock(in_channels=16, out_channels=32)
        ...
        self.conv_block_444 = ConvBatchNormReluBlock(in_channels=128 * 2 + 64, out_channels=128)
        self.conv_block_44 = ConvBatchNormReluBlock(in_channels=128, out_channels=64)
        self.conv_block_333 = ConvBatchNormReluBlock(in_channels=64 * 2 + 64, out_channels=64)
        self.conv_block_33 = ConvBatchNormReluBlock(in_channels=64, out_channels=32)
        self.conv_block_222 = ConvBatchNormReluBlock(in_channels=32 * 2 + 64, out_channels=32)
        self.conv_block_22 = ConvBatchNormReluBlock(in_channels=32, out_channels=16)
        self.conv_block_111 = ConvBatchNormReluBlock(in_channels=16 * 2 + 64, out_channels=16)
        self.conv_block_11 = ConvBatchNormReluBlock(in_channels=16, out_channels=8)
        ...
        self.channel_adjust = nn.Conv2d(in_channels=8, out_channels=out_channels, kernel_size=1, stride=1, padding=0)
