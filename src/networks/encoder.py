...
class EncoderV4(nn.Module):
    def __init__(self, in_channels=3, out_channels=3):
        ...
        self.conv_block_1_1 = ConvBatchNormReluBlock(in_channels=32, out_channels=16)
        self.conv_block_1_2 = ConvBatchNormReluBlock(in_channels=16 * 2 + 64, out_channels=16)
        self.conv_block_2_1 = ConvBatchNormReluBlock(in_channels=64, out_channels=32)
        self.conv_block_2_2 = ConvBatchNormReluBlock(in_channels=32 * 2 + 64, out_channels=32)
        self.conv_block_3_1 = ConvBatchNormReluBlock(in_channels=64 * 2 + 64, out_channels=64)
        self.conv_block_3_2 = ConvBatchNormReluBlock(in_channels=64 * 2 + 64, out_channels=64)
